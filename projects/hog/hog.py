...
def boar_brawl(player_score, opponent_score):
    ...
    t = abs(player_units_digit - opponent_tens_digit)
    if t >=1:
        return 3*t
    else:
        return 1
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    total_score=turn_score+player_score
    final_score=sus_points(total_score)
...
def is_always_roll(strategy, goal=GOAL):
    ...
    """"这里的strategy 可以是always roll five"""
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    boar_brawl_score2=boar_brawl(score,opponent_score)+score
    boar_brawl_score2=sus_points(boar_brawl_score2)
    if boar_brawl_score2-score>=threshold:
        return 0
